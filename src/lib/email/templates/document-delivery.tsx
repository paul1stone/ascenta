export function documentDeliveryEmail(params: {
  employeeName: string;
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;overflow:hidden;">
          ...
          <tr>
            <td style="padding:32px;">
              ...
              <p style="margin:0 0 16px;color:#334155;font-size:16px;">Your employer has shared the following document with you:</p>
              ...
              <p style="margin:0 0 24px;color:#334155;font-size:16px;">Please review the document and acknowledge receipt by clicking the button below:</p>
