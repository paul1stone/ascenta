...
import { TerrainIcon } from "@/components/icons";
...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen bg-glacier flex items-center justify-center pt-16 pb-20">
        <div className="w-full max-w-md px-4">
          <Card className="border-slate-200 shadow-xl">
            <CardHeader className="text-center pb-2">
              <div className="flex justify-center mb-4">
                <div className="bg-deep-blue p-3 rounded-xl">
                  <TerrainIcon className="size-8 text-summit" />
                </div>
              </div>
              <CardTitle className="text-2xl font-display font-black text-deep-blue uppercase">
                Welcome Back
              </CardTitle>
              <CardDescription>
              ...
              >
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <Link
                      href="#"
                      className="text-sm text-summit hover:text-summit-hover font-medium"
                    >
                      Forgot password?
                    </Link>
                  </div>
