  ...
  return (
    <SidebarInset className="bg-glacier">
      <header className="flex h-14 shrink-0 items-center gap-2 border-b bg-white px-6">
        <h1 className="font-display text-lg font-semibold text-deep-blue">Document Tracker</h1>
            ...
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="mt-1 text-muted-foreground">
                  Track and manage HR documents through their delivery lifecycle.
                </p>
              </div>
              {!loading && stats.total > 0 && (
                <div className="hidden sm:flex items-center gap-2 text-sm text-muted-foreground">
                  ...
                  {stats.lastUpdated && (
                    <span>Last activity {timeAgo(stats.lastUpdated.updatedAt)}</span>
                  )}
                </div>
              )}
            </div>
